...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/amzn/smoke-aws-generate.git", from: "2.0.0-beta.3"),
        .package(url: "https://github.com/amzn/service-model-swift-code-generate.git", from: "2.0.0-beta.1"),
    ],
    targets: [
        .target(
            name: "SmokeFrameworkApplicationGenerate",
